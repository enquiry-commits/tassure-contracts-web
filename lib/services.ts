...
export const ROW_DEFS: Record<string, { table: string; label: string; match: string }> = {
  ...
  OPT_ND_DEPOSIT_CN: { table: 'opt', label: 'Additional Deposit',                              match: '另付押金' },
  ...
  OPT_AIS:         { table: 'opt',  label: 'AIS/IR8A Services',                              match: 'AIS/IR8A Services' },
...
export const DEFAULT_MAPPING: Record<string, string[]> = {
  ...
  PAYROLL:      ['OPT_PAYROLL'],
  ND2:          ['OPT_ND'],
  ND_DEPOSIT2:  ['OPT_ND_DEPOSIT', 'OPT_ND_DEPOSIT_CN'],
...
export const ROW_ID_TO_SVC: Record<string, string> = {
  ...
  OPT_PERSONALTAX: 'PERSONALTAX', OPT_PAYROLL: 'PAYROLL', OPT_ND: 'ND2', OPT_ND_DEPOSIT: 'ND_DEPOSIT2', OPT_ND_DEPOSIT_CN: 'ND_DEPOSIT2',
  OPT_XBRL: 'XBRL', OPT_AUDIT: 'AUDIT', OPT_AIS: 'AIS',
